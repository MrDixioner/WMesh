...
def coef(segments):
    ...
    match segments:
        ...
        case 16:
            return 1.0256
        case segments if 18 <= segments < 22:
            return 1.0204
        case segments if 22 <= segments < 24:
            return 1.0152
        case segments if 24 <= segments < 30:
            return 1.01
        case segments if 30 <= segments < 52:
            return 1.005
        case segments if segments >= 52:
            return 1.0
