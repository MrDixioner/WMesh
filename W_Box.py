...
def geoGen_WBox (size_x, size_y, size_z, seg_x, seg_y, seg_z, centered):
    ...
    for y in range(seg_y + 1):
        ...
        for x in range(seg_x + 1):
            ...
            verts.append(Vector((x * dist_x-half_x, y * dist_y-half_y, 0.0)))
    ...
    for y in range(seg_y + 1):
        ...
        for x in range(seg_x + 1):
            line.append(len(verts))
            verts.append(Vector((x * dist_x-half_x, y * dist_y-half_y, size_z)))
    ...
    for z in range(seg_z - 1):
        ...
        for i in range(seg_x + 1):
            ...
            verts.append(Vector((i * dist_x-half_x, -half_y, (z + 1) * dist_z)))
        for i in range(seg_y - 1):
            loop.append(len(verts))
            verts.append(Vector((half_x, (i + 1) * dist_y-half_y, (z + 1) * dist_z)))
        for i in range(seg_x + 1):
            loop.append(len(verts))
            verts.append(Vector((
                half_x - (i * dist_x), half_y, (z + 1) * dist_z)))
        for i in range(seg_y - 1):
            loop.append(len(verts))
            verts.append(Vector((
                -half_x, half_y - ((i + 1) * dist_y), (z + 1) * dist_z)))
        loops.append(loop)
